    ...
    <div className='flex min-h-screen flex-col items-center justify-center py-2'>
      ...
      <main className='flex w-full flex-1 flex-col items-center justify-center px-20 text-center'>
        ...
        <div className='mt-6 flex max-w-4xl flex-wrap items-center justify-around sm:w-full'>
          <a href='https://nextjs.org/docs' className='mt-6 w-96 rounded-xl border p-6 hover:text-blue-600 focus:text-blue-600'>
            <h3 className='text-2xl font-bold'>Documentation &rarr;</h3>
            <p className='mt-4 text-xl'>Find in-depth information about Next.js features and API.</p>
          </a>

          <a href='https://nextjs.org/learn' className='mt-6 w-96 rounded-xl border p-6 hover:text-blue-600 focus:text-blue-600'>
      ...
      <footer className='mt-5 flex h-24 w-full items-center justify-center border-t'>
        <a
